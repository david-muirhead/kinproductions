...
@section('content')
  <div class="container-xl flex relative">
    <div class="w-full md:w-1/2 mt-10 pr-8 z-40">
    ...
    <span class="z-0 pl-6 image-change h-0 mt-64 md:mt-0 pb-64 md:pb-archive absolute top-0 right-0 w-64 md:w-1/2 bg-cover bg-center"></div>
  </div>  
@endsection
